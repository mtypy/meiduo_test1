...
CACHES = {
    ...
    "histories": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://192.168.92.128:6379/4",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    },
    ...
    "cart": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://192.168.92.128:6379/5",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    },
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'meiduo_test.utils.pagination.StandardResultPagination'
}
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.92.128:9200/',  # 此处为elasticsearch运行的服务器ip地址，端口号固定为9200
        'INDEX_NAME': 'meiduo_sh21',  # 指定elasticsearch建立的索引库的名称
    },
}
